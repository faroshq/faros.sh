...
| Path | What's in it |
|:-----|:-------------|
| `layouts/partials/connected-home/` | Connected Layers homepage and shared marketing head, navigation, and footer; homepage assembled by `layouts/index.html`; copy in `data/connected_home.json`, shared production metadata in `layouts/partials/head-metadata.html` |
