...
The hub's backend proxy authenticates the request and injects the identity headers your server trusts — see [Connectivity & proxies](/docs/extend/connectivity/).
