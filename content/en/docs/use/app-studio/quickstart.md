...
Build a small notes application, verify its development preview, and deploy one verified release. Start in the Railgrid SaaS hub. If your organization uses a [self-hosted hub](/docs/self-hosting/), follow this walkthrough there with the same workspace prerequisites.
