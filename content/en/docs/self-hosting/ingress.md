...
|:-------|:---------|:-----------|:-----------------|
| [Cloudflare Tunnel](/docs/self-hosting/cloudflare-tunnel/) | Home labs, no public IP | Medium | No |
...
> **Recommended for home labs:** [Cloudflare Tunnel](/docs/self-hosting/cloudflare-tunnel/) — no public IP needed, free TLS, free DDoS protection.
...
- [Cloudflare Tunnel walkthrough](/docs/self-hosting/cloudflare-tunnel/)
