...
Use the Railgrid SaaS hub to get started without operating the control plane. If you want to run Railgrid on your own infrastructure, choose the software you need to run:
...
Managing users on a running hub belongs in [Administration](/docs/administration/). Building a new provider belongs in [Extend Railgrid](/docs/extend/).
