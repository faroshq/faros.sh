...
|:-------|:---------|:------|
| **[Static token](/docs/self-hosting/hub/static-token/)** | Personal home lab, dev, CI | Generate tokens; list them in Helm values; log in with `--token` |
| **[OIDC (Dex)](/docs/self-hosting/hub/oidc/)** | Teams, audit logging, SSO | Deploy Dex + an identity backend (GitHub, Google, LDAP) |
