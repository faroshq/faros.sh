...
For Railgrid to work with remote agents, the hub must be reachable from:
...
|:-------|:---------|:-----------|:-----------------|
| [Cloudflare Tunnel](/docs/self-hosting/hub/cloudflare-tunnel/) | Home labs, no public IP | Medium | No |
...
> **Recommended for home labs:** [Cloudflare Tunnel](/docs/self-hosting/hub/cloudflare-tunnel/) — no public IP needed, free TLS, free DDoS protection.
...
> Railgrid uses HTTP/1.1 + WebSockets for all communication — works with any reverse proxy. No gRPC passthrough, no HTTP/2 termination, no ALPN gymnastics required.
...
- [Cloudflare Tunnel walkthrough](/docs/self-hosting/hub/cloudflare-tunnel/)
- [Security](/docs/administration/) — pick an auth method after you've decided how to expose the hub
